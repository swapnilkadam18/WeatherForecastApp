...
import com.tcs.android.weatherforecastapp.presenter.HourlyForecastDetailInfoPresenter;
 ...
 */
public class HourlyForecastMoreInfoFragment extends Fragment implements ForecastDetailInfoInterface.presenterToView {
    ...
    public HourlyForecastMoreInfoFragment() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewToPresenter = new HourlyForecastDetailInfoPresenter(this);
    }
    ...
    public static Fragment newInstance(int position) {
        HourlyForecastMoreInfoFragment hourlyForecastMoreInfoFragment = new HourlyForecastMoreInfoFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(Utilities.POSITION, position);
        hourlyForecastMoreInfoFragment.setArguments(bundle);
        return hourlyForecastMoreInfoFragment;
    }
