 ...
 */
public class HourlyForecastFragment extends Fragment implements ForecastSummaryInterface.presenterToView{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewToPresenter = new HourlyForecastPresenter(this);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hourlyForecastList = (RecyclerView) rootView.findViewById(R.id.recycler_view);
    ...
    private void populateList(List<ForecastListData> forecastListData) {
        HourlyForecastListAdapter hourlyForecastListAdapter = new HourlyForecastListAdapter(forecastListData,getActivity());
        hourlyForecastList.setAdapter(hourlyForecastListAdapter);
        Utilities.initRecyclerView(getActivity(),hourlyForecastList);
        hourlyForecastList.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), hourlyForecastList, new ClickListener() {
            @Override
            public void onClick(View view, int position) {
                callBackToMainActivityListener.changeFragment(ViewRequested.HOURLY_FORECAST_MORE_INFO,position);
            }
        }));
    }
